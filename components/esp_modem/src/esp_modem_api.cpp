...
std::unique_ptr<DCE> create_EG91_dce(const dce_config *config, std::shared_ptr<DTE> dte, esp_netif_t *netif)
{
    return create_modem_dce(dce_factory::ModemType::EG91, config, std::move(dte), netif);
}
