...
#define ARGS7 , p1 , p2 , p3, p4, p5, p6, p7
#define ARGS8 , p1 , p2 , p3, p4, p5, p6, p7, p8
...
command_result EG91::power_down()
{
    return dce_commands::power_down_eg91(dte.get());
}

command_result EG91::set_data_mode()
{
    return dce_commands::set_data_mode_eg91(dte.get());
}
